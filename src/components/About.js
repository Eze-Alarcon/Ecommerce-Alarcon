// const About = () => {
//     return (
//         <div className="bg-[#edf2f7] h-[100%]">
//             <div className="grid grid-cols-1 md:grid-cols-2">
//                 <div className="max-h-screen md:h-full">
//                     <img className="w-screen h-full object-cover object-top" 
//                         src="https://images.pexels.com/photos/270373/pexels-photo-270373.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt=""/>
//                 </div>
//                 <div className="flex bg-gray-100 p-10">
//                     <div className="mb-auto mt-auto">
//                         <h1 className="text-3xl uppercase">Ezequiel Alarcon</h1>
    ...
    return (
        ...
        <div className="max-w-4xl flex items-center h-auto lg:h-full flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                ...
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-center gap-16">
                        ...
                        {/* <a className="link" href=".#"><i className="h-6" style={{
                                backgroundImage: "url('../../public/resources/whatsapp.svg')",
            ...
            <div className="w-full lg:w-2/5">
                ...
                <img src="https://source.unsplash.com/koOdUvfGr4c" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt=""/>
