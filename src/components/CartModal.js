...
const CartModal = ({props}) => {
    ...
    const close = () => setModal(prevState => !prevState)
    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)} className="z-10 absolute w-[30vw] text-left py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
            ...
            <h1 className="text-gray-800 text-center font-lg font-bold tracking-normal leading-tight mb-4">Enter Billing Details</h1>

            <label htmlFor="name" className="w-full text-left text-gray-800 text-sm font-bold leading-tight tracking-normal">Name</label>
                <input 
                    id="name" 
                    required 
                    value={data.name}
            ...
            <label htmlFor="phone" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Phone Number</label>
                <input 
                    id="phone" 
                    value={data.phone}
                    onChange={handleChange}
            ...
            <label htmlFor="cardNumber" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Card Number</label>
            ...
            <label htmlFor="expiration" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Expiration Date</label>
